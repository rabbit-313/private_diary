# Generated by Django 3.2.7 on 2023-04-09 02:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('diary', '0005_alter_diary_api_key'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='diary',
            name='event4',
            field=models.CharField(blank=True, default='', max_length=40, null=True, verbose_name='出来事4'),
        ),
        migrations.AlterField(
            model_name='diary',
            name='event5',
            field=models.CharField(blank=True, default='', max_length=40, null=True, verbose_name='出来事5'),
        ),
    ]
